# Generated by Powerlevel10k configuration wizard on 2021-12-22 at 09:47 EST.
...
() {
  ...
  #######################[ rvm: ruby version from rvm (https://rvm.io) ]########################
  # Rvm color.
  typeset -g POWERLEVEL9K_RVM_FOREGROUND=15
  typeset -g POWERLEVEL9K_RVM_BACKGROUND=52
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_BACKGROUND=44
